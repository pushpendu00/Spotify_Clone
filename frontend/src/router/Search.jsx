...
const Search = () => {
    ...
    return (<>
        <div className={`Searchpage ${loginContext.isAuthenticate?(`${loginContext.masterPlay?('h-[calc(100%-5rem)]'):('h-[calc(100%)]')}`):('h-[calc(100%-5rem)]')} w-full bg-black flex`}>
